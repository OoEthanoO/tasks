  ...
  return (
    <main className="shell">
      ...
      <section className="card" style={{ maxWidth: 760, margin: "0 auto" }}>
        ...
        <p>Each stretch of accumulated work starts a tracked break, then work resumes: by default 30 minutes of rest after every 90 minutes of work. Change both lengths, or turn breaks off, beside the work day end time. Pausing stops either counter without bypassing an unfinished break. The work-day cutoff stops tracking. At midnight in your shared timer’s time zone, daily time is reset and tracking stays paused until you start again.</p>
